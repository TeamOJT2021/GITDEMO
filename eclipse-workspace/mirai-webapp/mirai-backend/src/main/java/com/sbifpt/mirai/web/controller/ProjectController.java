...
//
//	@Autowired
//	private ProjectRepository projectServiceImpl;
//
//	/**
...
//	public ResponseEntity<?> projects(Principal principal) {
...
//			List<Project> listProject = projectServiceImpl.findAllProjectByUserId(userId);
...
////				_project.setVisibility(project.getVisibility());
