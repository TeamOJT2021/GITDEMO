package com.sbifpt.mirai.web.security.jwt;
...
public class JwtUtils {
	...
	@Value("${mirai.app.jwtSecret}")
	private String jwtSecret;

	@Value("${mirai.app.jwtExpirationMs}")
	...
	/**
	 * 
	 * Validate JWT token timeout, empty, invalid, signature
	 * 
	 */
